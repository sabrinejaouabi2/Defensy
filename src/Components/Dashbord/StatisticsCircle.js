...
const CircleWithColorBorder = () => {
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: '37px', color: '#274191', textAlign: 'center',fontFamily:'sans-serif',fontWeight:'bold' }}>8</span>
      </div>
    </div>
  );
};

export default CircleWithColorBorder;
